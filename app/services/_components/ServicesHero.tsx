...
export function ServicesHero() {
    return (
        <section className="relative min-h-[335px] overflow-hidden md:min-h-[380px]">
            <Image
            ...
            <div
                className="relative z-10 mx-auto flex min-h-[335px] max-w-8xl items-center px-5 py-14 md:min-h-[380px] md:px-10">
                <Reveal variant="left" className="max-w-4xl text-white">
                    ...
                    <p className="mt-5 max-w-4xl text-[15px] font-medium leading-7 text-white/92 md:text-[16px]">
                    ...
                    <ul className="mt-1 max-w-4xl list-disc pl-6 text-[15px] font-medium leading-7 text-white/88 md:text-[16px]">
