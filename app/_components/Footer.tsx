...
export function Footer() {
    return (
        <footer className="bg-[#438f55] text-white">
            <div className="mx-auto max-w-8xl px-5 section-y md:px-10">
                <div className="flex items-center gap-4">
                    <Image src="/logo/white-logo.png" alt="Huang Shan Global" width={210} height={70}
                           className="h-16 w-auto"/>
                </div>
                <div className="mt-6 max-w-xl">
                    <h2 className="text-[21px] md:text-[24px] font-bold uppercase">Công ty cổ phần thương mại xuất khẩu</h2>
                ...
                <div
                    className="section-mt flex items-center justify-between border-t-2 border-white/80 pt-5 text-[14px] font-medium text-white/90">
